...
"ClinicalExperiment" <- function(number.of.factors=2,
  ...
  if (missing(factor.level.names)) {
      factor.level.names <- lapply(1:number.of.factors,
                                   function(x) paste(factor.names[x], 1:number.of.factor.levels[x], sep="-"))
...
##                                 treatment.names) {
##
setGeneric("numberOfFactors", function(x) standardGeneric("numberOfFactors"))
setMethod("numberOfFactors", "ClinicalExperiment", function(x) x@number.of.factors)

setGeneric("factorNames", function(x) standardGeneric("factorNames"))
setMethod("factorNames", "ClinicalExperiment", function(x) x@factor.names)

setGeneric("factorLevelNames", function(x) standardGeneric("factorLevelNames"))
setMethod("factorLevelNames", "ClinicalExperiment", function(x) x@factor.level.names)

setGeneric("numberOfTreatments", function(x) standardGeneric("numberOfTreatments"))
setMethod("numberOfTreatments", "ClinicalExperiment", function(x) x@number.of.treatments)

setGeneric("treatmentNames", function(x) standardGeneric("treatmentNames"))
setMethod("treatmentNames", "ClinicalExperiment", function(x) x@treatment.names)
...
setMethod("show", "PocockSimonRandomizer",
          function(object) {
              ...
              cat("Current State:\n"); print(slot(object, "stateTable"));
              cat("Treatment Assignments:\n"); print(slot(object, "tr.assignments"));
              cat("Factor-specific measure of imbalance:\n"); print(slot(object, "d.func"));
